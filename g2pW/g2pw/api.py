...
class G2PWConverter:
    def __init__(self, model_dir='/home/duser/tts/fastSpeech2-master/g2pw_models', style='bopomofo', model_source=None, use_cuda=True, num_workers=None, batch_size=None,
    ...
    def _prepare_data(self, sentences):
        ...
        #partial_results = pinyin(sent, neutral_tone_with_five=True, style=Style.TONE3)
        for sent_id, sent in enumerate(sentences):
            partial_results = [item[0] for item in pinyin(sent, neutral_tone_with_five=True, style=Style.TONE3)]
            #partial_result = [None] * len(sent)
            #pypinyin_result = pinyin(sent, neutral_tone_with_five=True, style=Style.TONE3)
            #punc = ",，.。!！?？"
